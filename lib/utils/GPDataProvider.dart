...
List<GPPeopleModel> getPeopleData() {
  ...
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Nidhi Jain"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Nidhi Jain"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Sristi"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Nupur Joe"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Raghuttam"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Kristy"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Aarushi"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Rohan"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Ekta"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Bhavya"));
  mList.add(GPPeopleModel("images/cloneApp/gPay/gp_user.jpg", "Lavina"));
...
List<GPContactModel> getContactData() {
  ...
  mList.add(GPContactModel(GPAY_user, "Nupur Jeswani", "+91 9876543210"));
  mList.add(GPContactModel(GP_user1, "Kristy", "+91 1234567890"));
  mList.add(GPContactModel(GP_user2, "Sristi", "+91 123457895"));
  mList.add(GPContactModel(GP_user3, "Nupur", "+91 7234567820"));
  mList.add(GPContactModel(GP_user4, "Raghuttam", "+91 92345678743"));
  mList.add(GPContactModel(GP_user5, "Ekta", "+91 92345678743"));
  mList.add(GPContactModel(GP_user6, "Bhavya", "+91 92345678743"));
  mList.add(GPContactModel(GP_user7, "Lavina", "+91 92345678743"));
  mList.add(GPContactModel(GP_user8, "Aarushi", "+91 92345678743"));
  mList.add(GPContactModel(GP_user9, "Bhavya", "+91 92345678743"));
  mList.add(GPContactModel(GP_user10, "Rohan", "+91 92345678743"));
...
List<GPDthDetailsModel> getPostPaidMobileData() {
  ...
  mList
      .add(GPDthDetailsModel(GP_img1, "EPay Postpaid Mobile", "Bill payments"));
  mList
      .add(GPDthDetailsModel(GP_img2, "EPay Postpaid Mobile", "Bill payments"));
  mList
      .add(GPDthDetailsModel(GP_img3, "EPay Postpaid Mobile", "Bill payments"));
  mList.add(GPDthDetailsModel(GP_img4, "EPay Postpaid", "Bill payments"));
  mList
      .add(GPDthDetailsModel(GP_img5, "EPay Postpaid Mobile", "Bill payments"));
...
List<GPDthDetailsModel> getPlayStoreData() {
  ...
  mList.add(
      GPDthDetailsModel(GP_img1, "EPay Store Recharge Code", "Bill payments"));
...
List<GPRechargeForYouModel> getForYouRechargeData() {
  ...
  mList.add(GPRechargeForYouModel("249",
      "Double Data Offer.Get Truly Unlimited Local/National Calls+1.5GB/D+Extra 1.5GB/D+100SMS/d.Val:28D"));
  mList.add(GPRechargeForYouModel("219",
      "Now Get Truly Unlimited Local/National Calls to all Networks +1GB/Day+100SMS/Day-Validity:28Days"));
  mList.add(GPRechargeForYouModel("399",
      "Double Data Offer.Get Truly Unlimited Local/National Calls+1.5GB/D+Extra 1.5GB/D+100SMS/d.Val:56D"));
  mList.add(GPRechargeForYouModel("599",
      "Double Data Offer.Get Truly Unlimited Local/National Calls+1.5GB/D+Extra 1.5GB/D+100SMS/d.Val:84D"));
  mList
      .add(GPRechargeForYouModel("16", "Get 1GB 4G/3G/2G Data-Validity:1 Day"));
  mList.add(
      GPRechargeForYouModel("48", "Get 1GB 4G/3G/2G Data-Validity:28 Day"));
...
List<GPRechargeDataModel> getRechargeDataModel() {
  ...
  mList.add(GPRechargeDataModel("995", " 7 days",
      "Voice: Upto 150 mins OG and Ic + Data: Upto 500 MB + SMS: RS. 25/SMS"));
  mList.add(GPRechargeDataModel("1495", "7 days",
      "Voice: Upto 300 mins OG and Ic + Data: Upto 500 MB + SMS: RS. 25/SMS"));
  mList.add(GPRechargeDataModel("1499", "365 days",
      "Voice: Truly Unlimited + Data: 24 GB 4G/3G/2G Data + SMS: 3600 SMS"));
  mList.add(GPRechargeDataModel("2399", "365 days",
      "Now get Truly Unlimited Local/National Calls to all Networks + 1.5GB/Day + 100 Local and National SMS/Day. Pack Validity for 365 Days."));
  return mList;
}

List<GPTopUpRechargeModel> getTopUpRechargeModel() {
  List<GPTopUpRechargeModel> mList = [];
  mList.add(GPTopUpRechargeModel(
      "1000", "847.46", "Talktime of Rs. 847.46,Talktime"));
  mList.add(GPTopUpRechargeModel(
      "5000", "4,237.29", "Talktime of Rs. 4237.29,Talktime"));
  mList.add(
      GPTopUpRechargeModel("12", "10 days", "Talktime of Rs. 7.47, Talktime"));
  mList.add(
      GPTopUpRechargeModel("23", "28 days", "Talktime of Rs. 16, Talktime"));
  mList.add(
      GPTopUpRechargeModel("30", "28 days", "Talktime of Rs. 22.42, Talktime"));
  return mList;
}
...
List<GPRechargeDataModel> getOtherRechargeModel() {
  List<GPRechargeDataModel> mList = [];
  mList.add(
      GPRechargeDataModel("12", "10 days", "SMS: 120 SMS Local and National"));
  mList.add(GPRechargeDataModel("23", "28 days", "Voice: ISD Packs"));
  mList.add(
      GPRechargeDataModel("26", "28 days", "SMS: 250 SMS Local and National"));
  mList.add(
      GPRechargeDataModel("36", "28 days", "SMS: 350 SMS Local and National"));
...
List<GPPopularBusinessModel> getPopularBusinessModel() {
  ...
  mList.add(GPPopularBusinessModel(
      GP_resort_img,
  ...
  mList.add(GPPopularBusinessModel(
      ...
      "Use code GPFIRST, now till Nov 30"));
  mList.add(GPPopularBusinessModel(
      Gp_gift_img,
      'Get 20% off your first Dunzo order',
...
List<GPBusinessSublistModel> getBusinessTravelList() {
  ...
  mList.add(GPBusinessSublistModel(
      GP_img1, "EPay", "Travel in India and aboard", "Book Travel"));
  return mList;
}
...
List<GPPopularBusinessModel> getFoodBusinessModel() {
  List<GPPopularBusinessModel> mList = [];
  mList.add(GPPopularBusinessModel(
      GP_food_img, 'Felling hungry? Discover restaurants here now!', "Zomato"));
  return mList;
}
...
List<GPBusinessSublistModel> getBusinessFoodList() {
  List<GPBusinessSublistModel> mList = [];
  mList.add(GPBusinessSublistModel(
      GP_img1, "EPay", "Tasty food delivered to you ", "Order food"));
  mList.add(GPBusinessSublistModel(
      GP_img2, "EPay", "Order your favorite burgers", "Order food"));
  return mList;
}
...
List<GPRewardAmountModel> getRewardAmount() {
  ...
  mList.add(GPRewardAmountModel(
      rewardAmount: "Better Luck", description: "next time"));
  mList.add(GPRewardAmountModel(
      rewardAmount: "Better Luck", description: "next time"));
  mList.add(GPRewardAmountModel(rewardAmount: "10", description: "You won"));
  mList.add(GPRewardAmountModel(rewardAmount: "5", description: "You won"));
...
List<GPOfferModel> getOfferData() {
  ...
  mList.add(GPOfferModel(GP_playstore_offer, "Earn up to \u20B9150",
      "On your first ever transactions of \u20B930 + on the $PSAppName"));
  mList.add(GPOfferModel(
      GP_youtube_offer,
      "Get up to \20B9399 on Youtube Premium",
      "Use $GPAYAppName to buy YouTube Premium 3-month plan and get up to  \u20B9399 as cashback"));
  mList.add(GPOfferModel(
      GP_electricity_offer,
      "Get \u20B920 to \u20B92000 on electricity bill pay..",
      "Make your 1st and 2st electricity bill payments ofe \u20B9"));
  mList.add(GPOfferModel(GP_visa_offer, "Get up to \20B9399 on Visa Premium",
...
List<GPAllTransactionsModel> getAllTransactionsData() {
  ...
  mList.add(
      GPAllTransactionsModel(GP_user1, "Bhavya", '28 November', '- \u20B9500'));
  mList.add(
      GPAllTransactionsModel(GP_user3, "Nupur", '21 November', '+ \u20B920'));
  mList
      .add(GPAllTransactionsModel(GP_user2, "Sristi", '20 May', '- \u20B9700'));
  mList.add(
      GPAllTransactionsModel(GP_user8, "Kristy", '31 March', '+ \u20B9690'));
  mList.add(GPAllTransactionsModel(
      GP_user4, "Nupur Jeswani", '27 March', '- \u20B9 500'));
  mList.add(
      GPAllTransactionsModel(GP_user1, "Aarushi", '26 March', '+ \u20B9 350'));
  mList.add(
      GPAllTransactionsModel(GP_user6, "Ekta", '22 March', '- \u20B9 220'));
  mList.add(
      GPAllTransactionsModel(GP_user7, "Bhavya", '20 March', '+ \u20B9 800'));
  return mList;
}
